...
def lade_excel_datei(pfad: str):
    try: # alles wird versucht, falls Fehler dann wird except ausgeführt
        ...
        pruefe_spalten(
            fragen,
            ["kriterium_id", "abhaengig_von_kriterium_id", "abhaengig_von_antwort", "frage_text", "frage_information", "frage_hilfetext", "antwort_datentyp", "option_1", "option_2", "option_3", "option_4"],
            "fragen"
        )
